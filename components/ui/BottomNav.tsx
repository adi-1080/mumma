...
export default function BottomNav() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 h-[68px] bg-cream border-t-[3px] border-dark flex items-center justify-around px-2 z-[999] md:hidden shadow-[0_-4px_10px_rgba(0,0,0,0.06)] pb-safe">
      ...
      <Link href="/dashboard" className={`flex flex-col items-center justify-center w-14 h-12 transition-all active:scale-95 ${getActiveClass('/dashboard')}`}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-5 h-5">
          <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6A2.25 2.25 0 016 3.75h2.25A2.25 2.25 0 0110.5 6v2.25a2.25 2.25 0 01-2.25 2.25H6a2.25 2.25 0 01-2.25-2.25V6zM3.75 15.75A2.25 2.25 0 016 13.5h2.25a2.25 2.25 0 012.25 2.25V18a2.25 2.25 0 01-2.25 2.25H6A2.25 2.25 0 013.75 18v-2.25zM13.5 6a2.25 2.25 0 012.25-2.25H18a2.25 2.25 0 012.25 6v2.25A2.25 2.25 0 0118 10.5h-2.25a2.25 2.25 0 01-2.25-2.25V6zM13.5 15.75a2.25 2.25 0 012.25-2.25H18a2.25 2.25 0 012.25 2.25V18A2.25 2.25 0 0118 20.25h-2.25A2.25 2.25 0 0113.5 18v-2.25z" />
        </svg>
        <span className="text-[10px] font-lilita tracking-wide mt-1">Dashboard</span>
      </Link>
    </div>
  );
}
